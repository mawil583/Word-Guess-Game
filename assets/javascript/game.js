...
let proton = new Audio('./assets/images/proton.mp3');
let velocity = new Audio("./assets/images/velocity.mp3");
let mass = new Audio("./assets/images/mass.mp3")
let energy = new Audio("./assets/images/energy.mp3")
let atom = new Audio("./assets/images/atom.mp3")
let compound = new Audio("./assets/images/compound.mp3")
let science = new Audio("./assets/images/science.mp3")
